...
import { ScrollArea } from "@/components/ui/scroll-area";
import { formatDistanceToNow } from "date-fns";
import { HeartIcon, MessageCircleIcon, UserPlusIcon, ReplyIcon } from "lucide-react";
              ...
              notifications.map((notification) => (
                ...
                >
                  ...
                  <div className="flex-1 space-y-1">
                    <div className="flex items-center gap-2">
                      ...
                      <span>
                        ...
                        {notification.type === "LIKE"
                          ...
                          ? "replied to your advice"
                          : "like your advice"}
                      </span>
                    </div>

                    {/* Display post content for LIKE and COMMENT */}
                    {notification.post &&
                      (notification.type === "LIKE" || notification.type === "COMMENT") && (
                        <div className="pl-6 space-y-2">
                          <div className="text-sm text-muted-foreground rounded-md p-2 bg-muted/30 mt-2">
                    ...
                    {notification.advice &&
                      (notification.type === "REPLY" || notification.type === "REPUTATION") && (
                        <div className="pl-6 space-y-2">
                          <div className="text-sm text-muted-foreground rounded-md p-2 bg-muted/30 mt-2">
                            <p>{notification.advice.content}</p>
                            {notification.advice.image && (
                              <img
                                src={notification.advice.image}
                                alt="Post content"
                                className="mt-2 rounded-md w-full max-w-[200px] h-auto object-cover"
                              />
                            )}
